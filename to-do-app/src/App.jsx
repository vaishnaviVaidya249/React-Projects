...
function App() {
  ...
  return (
    ...
    <div className=" mx-auto mt-[100px] w-[500px] h-[300px]  place-items-center flex flex-col items-center ">
        <h1 className="mt-5 font-bold text-3xl">Todo List</h1>
        <div className="flex gap-4 m-8">
        <input className=" border border-black p-2 rounded-md" type="text" value={input} onChange={(e)=>setinput(e.target.value)}
        ...
        <ul>
          {todos.map(({text,id})=>{
            return( 
            <li className="bg-violet-100 m-2 place-items-center border-none w-[260px] p-2 flow-root rounded-md" key={id}>
